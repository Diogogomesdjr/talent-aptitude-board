...
import EditPhotoDialog from "./collaborators/EditPhotoDialog";
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-white border shadow-sm hover:bg-gray-100"
                  ...
                  skillInfo && (
                    <div key={skillInfo.id} className="flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>{skillData.isApt ? "Apto para conhecimento" : "Não apto"}</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  )
